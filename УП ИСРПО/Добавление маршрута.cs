    ...
    public partial class Добавление_маршрута : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (comboBox1.Text!= "" && textBox1.Text != "" && textBox2.Text != "" && textBox3.Text != "" && textBox4.Text != "")
            {
                ...
                string insertquery = "INSERT INTO Маршруты(Код_поезда, Пункт_отправление,Пункт_прибытия,Дата_отправление,Станция) VALUES ('" + Код_поезда + "','" + Пункт_отправление + "','" + Пункт_прибытия + "','" + Дата_отправление + "','" + Станция + "')";
